...
files_to_process = [
    ("terjemahan_pertanyaan_gpt_train_id.jsonl", "parafrasa_pertanyaan_gpt_train_id.jsonl"),
    ("terjemahan_pertanyaan_gpt_dev_id.jsonl", "parafrasa_pertanyaan_gpt_dev_id.jsonl"),
    ("terjemahan_pertanyaan_gpt_test_id.jsonl", "parafrasa_pertanyaan_gpt_test_id.jsonl")
]
